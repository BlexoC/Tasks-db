...
Creates a table if it does not exist and then create a delete command to clear the table before inserting new data afterwwards is when data is inserted. Commit the changes to the database 
